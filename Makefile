...
OBJECTS = agent.o env.o minesweeper.o kdtree.o

# https://www.gnu.org/software/make/manual/html_node/Implicit-Variables.html
# CXX = g++
CXX = clang++
CPPFLAGS = -Wall -std=c++23 -O3 -g
# LDFLAGS =
...
agent.o: agent.cc agent.h kdtree.h point.h minesweeper.h
env.o: env.cc env.h kdtree.h point.h minesweeper.h
kdtree.o: kdtree.cc kdtree.h point.h
minesweeper.o: minesweeper.cc agent.h kdtree.h point.h minesweeper.h \
 env.h
